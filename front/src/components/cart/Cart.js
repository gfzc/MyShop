                    ...
                    <div className="row d-flex justify-content-between">
                                    ...
                                    <div className="cart-item" key={item.nombre}>
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                                <i id="delete_cart_item" className="fa fa-trash btn btn-danger" onClick={() => removeCartItemHandler(item.product)}></i>                                            </div>
                        ...
                        <div className="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Total: <span className="order-summary-values">${cartItems.reduce((acc, item)=> acc+(item.quantity*item.precio),0).toFixed(2)}</span></p>
                                <hr />
